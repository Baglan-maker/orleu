...
const ACHIEVEMENTS = [
  ...
  { label: '7-Day',      icon: (_c: string) => <IFire/>,          earned: true  },
...
export default function StatsScreen() {
  ...
  // Derive stats from progress or fallback
        ...
        <Card>
          ...
          <View style={s.achRow}>
            {ACHIEVEMENTS.map((a, i) => {
              const earned = a.earned && totalWorkouts > 0;
              return (
                <View key={i} style={[s.achItem, !earned && { opacity: 0.25 }]}>
                  <View style={[
                    s.achBox,
                    earned
                    ...
                    {a.icon(earned ? Colors.cr : Colors.t3)}
                  </View>
